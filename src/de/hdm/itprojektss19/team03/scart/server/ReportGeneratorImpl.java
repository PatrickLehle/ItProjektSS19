...
public class ReportGeneratorImpl extends RemoteServiceServlet implements ReportGenerator {
	...
	// public CompositeReport getReport(Vector<String> cGroupString, Timestamp
	// cStartDate,
	// Timestamp cEndDate, Timestamp cStartDatePl1TS, Timestamp cEndPl1TS,
	// Vector<SimpleReport> cReports, User user) {
	//
	//
	...
	public ArticleReport createStatisticA(User u) throws IllegalArgumentException, DatabaseException {
		...
		// groupsByUser =
		// GroupUserMapper.groupUserMapper().findAllGroupsByUser(u.getId());
		...
		// Hier werden die Article einer GroceryList via des zsmgesetzten Schluessels
		// identifiziert
	...
	public ArticleReport createStatisticA(User u, Group g) throws IllegalArgumentException {
		...
		// articleRow.addColumn(new
		// Column(String.valueOf(this.editorService.findAllArticle())));
		//
	...
	public ArticleDateRetailerReport createStatisticADR(Vector<String> choosenUsers, Timestamp choosenStartDate,
		...
		//
		// @SuppressWarnings("deprecation")
		// String tempD2 = (choosenEndDate.getDate()) + "." + (choosenEndDate.getMonth()
		// + 1) + "."
		...
		//
		//
		// choosenStartDatePl1TS.setTime(choosenStartDate.getTime() + (1000 * 60 * 60 *
		// 24));
		// choosenEndDatePl1TS.setTime(choosenEndDate.getTime() + (1000 * 60 * 60 *
		// 24));
		//
		...
		//
		//// ---------------------------------------------------------------------------------
		////// Befüllen des gesamten Reports mit den angeforderten Reports über
		// angeforderte User
		//
		...
		// + choosenUsers.elementAt(i).getLastName() + " " + "(" +
		// choosenUsers.elementAt(i).getNickName()
		// + ")");
		//
		...
		// choosenStartDate, choosenEndDate, choosenStartDatePl1TS,
		// choosenEndDatePl1TS));
		//
	...
	// @Override
	// public CompositeReport getReport(Vector<String> choosenGroupss, Timestamp
	// choosenStartDate, Timestamp choosenEndDate,
	// Timestamp choosenStartDatePl1TS, Timestamp choosenEndDatePl1TS,
	// Vector<SimpleReport> choosenReports,
	...
	private String getUserByGMail(User u) throws IllegalArgumentException, DatabaseException {
	...
	private Vector<Group> getGroupByUser(int userId) throws IllegalArgumentException, DatabaseException {
